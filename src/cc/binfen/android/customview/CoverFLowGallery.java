...
import android.widget.SpinnerAdapter;
	...
	public class CoverFLowGallery extends Gallery {
	    ...
	    public CoverFLowGallery(final Context context) {
	        super(context);
	        this.setStaticTransformationsEnabled(true);
	    }

	    public CoverFLowGallery(final Context context, final AttributeSet attrs) {
	        this(context, attrs, android.R.attr.galleryStyle);
	    }

	    public CoverFLowGallery(final Context context, final AttributeSet attrs, final int defStyle) {
